package com.guyuan.heartrate.service;
...
public class CenterService extends Service {
    ...
    private final ScanCallback mScanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if (name != null && !devList.contains(dev)) {
...
//      }
    ...
    public static class BleDev implements Parcelable {
        ...
        public static final Creator<BleDev> CREATOR = new Creator<BleDev>() {
            @Override
            public BleDev createFromParcel(Parcel in) {
                return new BleDev(in);
            }
